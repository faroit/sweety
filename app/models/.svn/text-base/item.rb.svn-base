class Item < ActiveRecord::Base
  ...
  validates_presence_of :shop, :on => :create, :message => "Lagerstand muss gesetzt werden"
  validates_presence_of :quantity, :on => :create, :message => "Lagerstand muss gesetzt werden" 
